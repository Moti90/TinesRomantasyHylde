...
- middle grade
- picture book
- ren non-romance high fantasy
- klart uden for includeGenres
- den primære romance er M/M eller F/F
- hovedromancen ikke er M/F eller reverse harem med kvindelig FMC
        ...
        input: [
          {
            role: "system",
            content:
              "Du filtrerer bogforslag mod en adult romantasy-læseprofil. Returnér KUN JSON. Behold primært M/F-romantasy og reverse harem med kvindelig FMC. Sortér M/M- og F/F-romancer fra. Vær også streng over for børne-/MG-bøger.",
          },
          { role: "user", content: prompt },
        ],
      });
